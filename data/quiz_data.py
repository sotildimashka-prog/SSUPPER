...
QUESTIONS = [
    {
        "question": "Free Fire o'yinida bitta o'yin (match) da odatda nechta o'yinchi ishtirok etadi?",
        "options": ["12", "50", "100", "24"],
        "correct": 1,
    },
    {
        "question": "Free Fire xaritalaridan biri qaysi?",
        "options": ["Bermuda", "Atlantis", "Krakatoa Island", "Mars"],
        "correct": 0,
    },
    {
        "question": "Free Fire'da dushmanni ko'rish uchun ishlatiladigan qurilma nima deb ataladi?",
        "options": ["Gloo Wall", "Scan Grenade", "Med Kit", "Airdrop"],
        "correct": 1,
    },
    {
